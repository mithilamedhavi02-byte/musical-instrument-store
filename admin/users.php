...
if(isset($_POST['update_role'])) {
    ...
    db_query($update_query, [$role, $user_id]);
    header("Location: users.php");
    exit();
}
            ...
            <div class="col-md-3 col-lg-2 bg-dark text-white min-vh-100">
                <div class="p-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2">
                            <a href="users.php" class="nav-link text-white bg-primary rounded">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" class="d-inline">
                                                ...
                                                <button type="submit" name="update_role" class="d-none">Update</button>
                                            </form>
                                            <?php endif; ?>
                                        </td>
