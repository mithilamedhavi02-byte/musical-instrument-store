<?php
// Session check kireema
if (session_status() === PHP_SESSION_NONE) { 
    session_start(); 
}

// Security Check: Login wela naththan kelinma eliyata yawanna
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm fixed-top">
   <div class="container-fluid">
      <a class="navbar-brand fw-bold text-warning" href="admin_page.php">
      ...
      <div class="ms-auto d-flex align-items-center">
         ...
         <div class="dropdown">
            <div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center shadow-sm pointer" 
                 style="width: 40px; height: 40px;" id="userMenu" data-bs-toggle="dropdown">
...
<style>
   :root {
      --sidebar-width: 260px;
      --primary-color: #ffc107; /* Warning Gold */
      --dark-bg: #1a1d20;
   }
...
<div class="sidebar shadow">
   ...
   <a href="admin_page.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'admin_page.php') ? 'active' : ''; ?>">
